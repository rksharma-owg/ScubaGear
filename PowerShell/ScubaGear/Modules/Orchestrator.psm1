                ...
                try {
                    ...
                    switch ($Product) {
                        ...
                        "securitysuite" {
                            ...
                            if ($ConnectionResult.ComplianceAccessToken -and $ConnectionResult.ComplianceApiEndpoint) {
                                $SecuritySuiteProviderParams['ComplianceAccessToken'] = $ConnectionResult.ComplianceAccessToken
                                $SecuritySuiteProviderParams['ComplianceApiEndpoint'] = $ConnectionResult.ComplianceApiEndpoint
                            }
